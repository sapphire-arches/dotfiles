...
syn keyword z80PreProc .end .list .nolist
...
syn keyword z80PreProc DEVICE ABYTE ABYTEC ABYTEZ ALIGN ASSERT BINARY BLOCK
" BYTE
...
syn keyword z80PreProc ENDMODULE EXPORT FIELD FPOS INCBIN INCHOB INCLUDE
" INCLUDELUA 
syn keyword z80PreProc INCTRD INSERT LABELSLIST LUA MAP MEMORYMAP MODULE ORG
syn keyword z80PreProc OUTPUT PAGE PHASE REPT SAVEBIN SAVEHOB SAVESNA
" SAVETRD SHELLEXEC 
...
syn region z80Lbl2 start="(" end=")" oneline
"contains=z80Number,z80Lbl,z80Lbl2,z80Other
...
syn region z80Reg start=/(ix/ end=/)/ keepend oneline
"contains=z80Lbl,z80Number,z80Reg,z80Other
syn region z80Reg start=/(iy/ end=/)/ keepend oneline
"contains=z80Lbl,z80Number,z80Reg,z80Other
...
"keepend contains=z80Comment,z80Comment2 
